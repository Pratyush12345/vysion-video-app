...
import 'package:flutter_webrtc_demo/Authentication/PersonDetail.dart';
...
class CallSample extends StatefulWidget {
  ...
  CallSample({Key key, @required this.ip, this.messageId}) : super(key: key);

  @override
  _CallSampleState createState() =>
      new _CallSampleState(serverIP: ip, messageId: messageId);
}
...
class _CallSampleState extends State<CallSample> {
  ...
  bool audio = false;
  bool video = false;
  _CallSampleState({Key key, @required this.serverIP, this.messageId});
