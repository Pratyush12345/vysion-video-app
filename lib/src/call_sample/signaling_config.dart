 ...
 */
typedef void SignalingStateCallback(SignalingConfState state);
...
class SignalingConf {
  ...
  void invite(String peer_id, String media, use_screen) {
    ...
    if (this.onStateChange != null) {
      this.onStateChange(SignalingConfState.CallStateNew);
    }
      ...
      case 'leave':
        {
          ...
          if (this.onStateChange != null) {
            this.onStateChange(SignalingConfState.CallStateBye);
          }
        }
        break;
      case 'bye':
  ...
  void connect() async {
    ...
    _socket.onOpen = () {
      print('onOpen');
      this?.onStateChange(SignalingConfState.ConnectionOpen);
      _send('new', { 
    ...
    _socket.onClose = (int code, String reason) {
      ...
      if (this.onStateChange != null) {
        this.onStateChange(SignalingConfState.ConnectionClosed);
      }
    };
